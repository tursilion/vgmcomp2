...
The code will also accept all lowercase "music" as the DEF name.

Then it's simple:

CALL LINK("SONGGO")
- will search the ref/def table for the label MUSIC (or 'music') and play the first song from that entry
