/*
 ...
 Modified for QND PC use by M.Brent aka Tursi
...
// Don't be fooled. There's this nice class-based interface
// but all the data is global, so you still only get one SID
// TODO: move the data into the class, and life will be happier
class SIDChip
{
  ...
  private:
    ...
    void checkgate(Voice_t *voice, uint8_t value);
};
