...
int getByte(STREAM *str, unsigned char *buf) {
                        ...
                        if (strDat[3].mainPtr) {
                            ...
                            if (strDat[3].mainPtr) {
                                if (testay) {
                                    ...
                                    if (y&0x04) curFreq[3] |= NOISE_PERIODIC;
...
int main(int argc, char *argv[])
{
	...
	if (argc < 2) {
		printf("testPlayPSG [-ay|-psg] [-scfsong x] [-hidenotes] [<file prefix> | <file.scf> | <track1> <track2> ...]\n");
